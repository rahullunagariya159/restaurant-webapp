...
import { createUnapprovedItem, sendEmailToAdmin,createCardPoint } from "../../graphql/mutations";
...
const AddCard = ({ handleClose,item }) => {
  ...
  const createItem = async () => {
    ...
    try {
      ...
      await onAprrovedItem(unapprrovedResult?.data?.createUnapprovedItem);
      ...
      toast.success("New menu item card has been created successfully");
